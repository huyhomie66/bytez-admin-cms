"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[5516],{
...
const InstallPluginButton = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm.useTracking)();
  const { copy } = (0,helper_plugin_esm.useClipboard)();
  ...
  if (isInstalled) {
    return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Check["default"], marginRight: 2, width: 12, height: 12, color: "success600" }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "omega", textColor: "success600", fontWeight: "bold" }, formatMessage({
...
const VerticalDivider = (0,styled_components_browser_esm["default"])(Divider/* Divider */.i)`
  width: ${(0,helper_plugin_esm.pxToRem)(12)};
  transform: rotate(90deg);
`;
const PackageStats = ({ githubStars, npmDownloads, npmPackageType }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, !!githubStars && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Github/* default */.Z, height: (0,helper_plugin_esm.pxToRem)(12), width: (0,helper_plugin_esm.pxToRem)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Star_o, height: (0,helper_plugin_esm.pxToRem)(12), width: (0,helper_plugin_esm.pxToRem)(12), color: "warning500", "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
  ...
  ), /* @__PURE__ */ react.createElement(VerticalDivider, { unsetMargin: false, background: "neutral200" })), /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: Download/* default */.Z, height: (0,helper_plugin_esm.pxToRem)(12), width: (0,helper_plugin_esm.pxToRem)(12), "aria-hidden": true }), /* @__PURE__ */ react.createElement(
    "p",
    {
      "aria-label": formatMessage(
        {
...
const NpmPackagesGrid = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  if (status === "error") {
    return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { paddingTop: 8 }, /* @__PURE__ */ react.createElement(helper_plugin_esm.AnErrorOccurred, null));
  }
  if (status === "loading") {
...
const FiltersFlex = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  /* Hide the label, every input needs a label. */
  label {
    border: 0;
    clip: rect(0 0 0 0);
...
const NpmPackagesPagination = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.PageSizeURLQuery, { options: ["12", "24", "50", "100"], defaultValue: "24" }), /* @__PURE__ */ react.createElement(helper_plugin_esm.PaginationURLQuery, { pagination })));
};
...
const OfflineLayout = () => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(components_PageHeader, { isOnline: false }), /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    {
      ...
      paddingTop: (0,helper_plugin_esm.pxToRem)(120)
    },
...
const MarketPlacePage = () => {
  ...
  const { autoReload: isInDevelopmentMode, dependencies, useYarn, strapiVersion } = (0,helper_plugin_esm.useAppInfo)();
...
const ProtectedMarketPlace = () => /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: permissions/* default */.Z.marketplace.main }, /* @__PURE__ */ react.createElement(MarketPlacePage, null));
