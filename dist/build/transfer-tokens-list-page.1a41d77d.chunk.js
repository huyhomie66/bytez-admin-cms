"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[9600],{
...
const LinkStyled = (0,styled_components_browser_esm["default"])(helper_plugin_esm.Link)`
  svg {
    path {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, sortedTokens.map((token) => {
      return /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Cell.Td, { maxWidth: (0,helper_plugin_esm.pxToRem)(250) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800", fontWeight: "bold", ellipsis: true }, token.name)),
        /* @__PURE__ */ react.createElement(Cell.Td, { maxWidth: (0,helper_plugin_esm.pxToRem)(250) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800", ellipsis: true }, token.description)),
        /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.RelativeTime, { timestamp: new Date(token.createdAt) }))),
        /* @__PURE__ */ react.createElement(Cell.Td, null, token.lastUsedAt && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.RelativeTime, { timestamp: new Date(token.lastUsedAt) }))),
...
const TransferTokenListView = () => {
  ...
  const { get, del } = (0,helper_plugin_esm.useFetchClient)();
  (0,react.useEffect)(() => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, !canRead && /* @__PURE__ */ react.createElement(helper_plugin_esm.NoPermissions, null), shouldDisplayDynamicTable && /* @__PURE__ */ react.createElement(
    Table/* default */.Z,
    {
...
const ProtectedTransferTokenListView = () => /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: permissions/* default */.Z.settings["transfer-tokens"].main }, /* @__PURE__ */ react.createElement(ListView, null));
