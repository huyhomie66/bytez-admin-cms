"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[5199],{
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      ), canDelete && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 1, ...helper_plugin_esm.stopPropagation }, /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
...
const schema = yup_es/* object */.Ry().shape({
  firstname: yup_es/* string */.Z_().trim().required(helper_plugin_esm.translatedErrors.required),
  ...
  roles: yup_es/* array */.IX().min(1, helper_plugin_esm.translatedErrors.required).required(helper_plugin_esm.translatedErrors.required)
});
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.PageSizeURLQuery, null), /* @__PURE__ */ react.createElement(helper_plugin_esm.PaginationURLQuery, { pagination })));
};
...
const tableHeaders = [
  ...
  },
  {
    ...
    cellFormatter({ isActive }, { formatMessage }) {
      return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.Status, { isActive, variant: isActive ? "success" : "danger" }), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral800" }, formatMessage({
...
function ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);enumerableOnly&&(symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable;})),keys.push.apply(keys,symbols);}return keys;}function _objectSpread(target){for(var i=1;i<arguments.length;i++){var source=null!=arguments[i]?arguments[i]:{};i%2?ownKeys(Object(source),!0).forEach(function(key){(0,defineProperty/* default */.Z)(target,key,source[key]);}):Object.getOwnPropertyDescriptors?Object.defineProperties(target,Object.getOwnPropertyDescriptors(source)):ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key));});}return target;}var CreateAction=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(49823)/* ["default"] */ .Z);}return (__webpack_require__(4214)/* ["default"] */ .Z);}();var useLicenseLimitNotification=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(94018)/* ["default"] */ .Z);}return (__webpack_require__(67875)/* ["default"] */ .Z);}();var EE_LICENSE_LIMIT_QUERY_KEY=['ee','license-limit-info'];var ListPage=function ListPage(){var _useFetchClient=(0,helper_plugin_esm.useFetchClient)(),post=_useFetchClient.post;var _useAPIErrorHandler=(0,helper_plugin_esm.useAPIErrorHandler)(),formatAPIError=_useAPIErrorHandler.formatAPIError;var _useState=(0,react.useState)(false),_useState2=(0,slicedToArray/* default */.Z)(_useState,2),isModalOpened=_useState2[0],setIsModalOpen=_useState2[1];var _useRBAC=(0,helper_plugin_esm.useRBAC)(permissions/* default */.Z.settings.users),_useRBAC$allowedActio=_useRBAC.allowedActions,canCreate=_useRBAC$allowedActio.canCreate,canDelete=_useRBAC$allowedActio.canDelete,canRead=_useRBAC$allowedActio.canRead;var queryClient=(0,es.useQueryClient)();var toggleNotification=(0,helper_plugin_esm.useNotification)();var _useIntl=(0,useIntl/* default */.Z)(),formatMessage=_useIntl.formatMessage;var _useLocation=(0,react_router/* useLocation */.TH)(),search=_useLocation.search;(0,helper_plugin_esm.useFocusWhenNavigate)();useLicenseLimitNotification();var _useAdminUsers=(0,useAdminUsers/* useAdminUsers */.R)(lib_default().parse(search,{ignoreQueryPrefix:true}),{enabled:canRead}),users=_useAdminUsers.users,pagination=_useAdminUsers.pagination,isError=_useAdminUsers.isError,isLoading=_useAdminUsers.isLoading,refetchAdminUsers=_useAdminUsers.refetch;var headers=utils_tableHeaders.map(function(header){return _objectSpread(_objectSpread({},header),{},{metadatas:_objectSpread(_objectSpread({},header.metadatas),{},{label:formatMessage(header.metadatas.label)})});});var title=formatMessage({id:'global.users',defaultMessage:'Users'});var handleToggle=function handleToggle(){setIsModalOpen(function(prev){return!prev;});};var deleteAllMutation=(0,es.useMutation)(/*#__PURE__*/function(){var _ref=(0,asyncToGenerator/* default */.Z)(/*#__PURE__*/regenerator_default().mark(function _callee(ids){return regenerator_default().wrap(function _callee$(_context){while(1)switch(_context.prev=_context.next){case 0:_context.next=2;return post('/admin/users/batch-delete',{ids:ids});case 2:case"end":return _context.stop();}},_callee);}));return function(_x){return _ref.apply(this,arguments);};}(),{onSuccess:function onSuccess(){return (0,asyncToGenerator/* default */.Z)(/*#__PURE__*/regenerator_default().mark(function _callee2(){return regenerator_default().wrap(function _callee2$(_context2){while(1)switch(_context2.prev=_context2.next){case 0:_context2.next=2;return refetchAdminUsers();case 2:_context2.next=4;return queryClient.refetchQueries(EE_LICENSE_LIMIT_QUERY_KEY);case 4:case"end":return _context2.stop();}},_callee2);}))();},onError:function onError(error){toggleNotification({type:'warning',message:{id:'notification.error',message:formatAPIError(error),defaultMessage:'An error occured'}});}});return/*#__PURE__*/react.createElement(Main/* Main */.o,{"aria-busy":isLoading},/*#__PURE__*/react.createElement(helper_plugin_esm.SettingsPageTitle,{name:"Users"}),/*#__PURE__*/react.createElement(HeaderLayout/* HeaderLayout */.T,{primaryAction:canCreate&&/*#__PURE__*/react.createElement(CreateAction,{onClick:handleToggle}),title:title,subtitle:formatMessage({id:'Settings.permissions.users.listview.header.subtitle',defaultMessage:'All the users who have access to the Strapi admin panel'})}),canRead&&/*#__PURE__*/react.createElement(ActionLayout/* ActionLayout */.Z,{startActions:/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(helper_plugin_esm.SearchURLQuery,{label:formatMessage({id:'app.component.search.label',defaultMessage:'Search for {target}'},{target:title})}),/*#__PURE__*/react.createElement(Filters/* default */.Z,{displayedFilters:utils_displayedFilters}))}),/*#__PURE__*/react.createElement(ContentLayout/* ContentLayout */.D,{canRead:canRead},!canRead&&/*#__PURE__*/react.createElement(helper_plugin_esm.NoPermissions,null),isError&&/*#__PURE__*/react.createElement("div",null,"TODO: An error occurred"),canRead&&/*#__PURE__*/react.createElement(react.Fragment,null,/*#__PURE__*/react.createElement(helper_plugin_esm.DynamicTable,{contentType:"Users",isLoading:isLoading,onConfirmDeleteAll:deleteAllMutation.mutateAsync,onConfirmDelete:function onConfirmDelete(id){return deleteAllMutation.mutateAsync([id]);},headers:headers,rows:users,withBulkActions:true,withMainAction:canDelete},/*#__PURE__*/react.createElement(DynamicTable_TableRows,{canDelete:canDelete,headers:headers,rows:users,withBulkActions:true,withMainAction:canDelete})),pagination&&/*#__PURE__*/react.createElement(ListPage_PaginationFooter,{pagination:pagination}))),isModalOpened&&/*#__PURE__*/react.createElement(ListPage_ModalForm,{onSuccess:/*#__PURE__*/(0,asyncToGenerator/* default */.Z)(/*#__PURE__*/regenerator_default().mark(function _callee3(){return regenerator_default().wrap(function _callee3$(_context3){while(1)switch(_context3.prev=_context3.next){case 0:_context3.next=2;return refetchAdminUsers();case 2:_context3.next=4;return queryClient.refetchQueries(EE_LICENSE_LIMIT_QUERY_KEY);case 4:case"end":return _context3.stop();}},_callee3);})),onToggle:handleToggle}));};/* harmony default export */ const Users_ListPage = (ListPage);
;// CONCATENATED MODULE: ./.cache/admin/src/pages/SettingsPage/pages/Users/ProtectedListPage/index.js




const ProtectedListPage = () => /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: permissions/* default */.Z.settings.users.main }, /* @__PURE__ */ react.createElement(Users_ListPage, null));
...
const MagicLinkWrapper = ({ children, target }) => {
  ...
  const { formatMessage } = (0,react_intl__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z)();
  const { copy } = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.useClipboard)();
...
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(73599);
...
const rotation = styled_components__WEBPACK_IMPORTED_MODULE_3__.keyframes`
  from {
...
`;
const LoadingWrapper = styled_components__WEBPACK_IMPORTED_MODULE_3__["default"].div`
...
const fetchData = async () => {
  const { get } = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_2__.getFetchClient)();
  const { data } = await get("/admin/roles");
  return data.data;
};
const SelectRoles = ({ disabled, error, onChange, value }) => {
  const { status, data } = (0,react_query__WEBPACK_IMPORTED_MODULE_1__.useQuery)(["roles"], fetchData, {
    staleTime: 5e4
  });
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__/* .Flex */ .k, { gap: 2 }, !lodash_isNil__WEBPACK_IMPORTED_MODULE_1___default()(permittedSeats) && shouldStopCreate && /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system__WEBPACK_IMPORTED_MODULE_6__/* .Icon */ .J,
      {
        ...
        height: `${14 / 16}rem`,
        color: "danger500",
        as: _strapi_icons__WEBPACK_IMPORTED_MODULE_7__["default"]
      }
    )
  ), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
