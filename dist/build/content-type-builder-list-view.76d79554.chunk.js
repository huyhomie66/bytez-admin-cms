"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[5905],{
...
const CloseButton = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: absolute;
  display: none;
  top: 5px;
  right: ${(0,helper_plugin_esm.pxToRem)(8)};

  svg {
    width: ${(0,helper_plugin_esm.pxToRem)(10)};
    height: ${(0,helper_plugin_esm.pxToRem)(10)};
...
`;
const ComponentBox = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: ${(0,helper_plugin_esm.pxToRem)(140)};
  height: ${(0,helper_plugin_esm.pxToRem)(80)};
  position: relative;
...
const Tr_Tr = styled_components_browser_esm["default"].tr`
  ...
  &.dynamiczone-row {
    ...
    > td:first-of-type {
      padding: 0 0 0 ${(0,helper_plugin_esm.pxToRem)(20)};
      position: relative;

      &::before {
        content: '';
        width: ${(0,helper_plugin_esm.pxToRem)(4)};
...
const StyledAddIcon = (0,styled_components_browser_esm["default"])(Plus["default"])`
  ...
  padding: ${(0,helper_plugin_esm.pxToRem)(9)};
  border-radius: ${(0,helper_plugin_esm.pxToRem)(64)};
  background: ${({ theme }) => theme.colors.primary100};
  path {
    fill: ${({ theme }) => theme.colors.primary600};
  }
...
const FixedBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  height: ${(0,helper_plugin_esm.pxToRem)(90)};
  position: absolute;
  width: 100%;
  top: 0;
  left: 0;
`;
const ScrollableStack = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: 100%;
  overflow-x: auto;
`;
const ComponentContentBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  padding-top: ${(0,helper_plugin_esm.pxToRem)(90)};
`;
const ComponentStack = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  flex-shrink: 0;
  width: ${(0,helper_plugin_esm.pxToRem)(140)};
  height: ${(0,helper_plugin_esm.pxToRem)(80)};
...
function List({
  ...
  if (!targetUid) {
    return /* @__PURE__ */ react.createElement(Table/* Table */.i, { colCount: 2, rowCount: 2 }, /* @__PURE__ */ react.createElement(Thead/* Thead */.h, null, /* @__PURE__ */ react.createElement(Tr.Tr, null, /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.name", defaultMessage: "Name" }))), /* @__PURE__ */ react.createElement(Cell.Th, null, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "neutral600" }, formatMessage({ id: "global.type", defaultMessage: "Type" }))))), /* @__PURE__ */ react.createElement(
      helper_plugin_esm.EmptyBodyTable,
      {
        colSpan: 2,
        content: {
...
function ListRow({
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement("td", null, isInDevelopmentMode ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "flex-end", ...helper_plugin_esm.stopPropagation }, configurable ? /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 1 }, !isMorph && /* @__PURE__ */ react.createElement(
      ...
      */
      /* @__PURE__ */ react.createElement(Box/* Box */.x, { height: (0,helper_plugin_esm.pxToRem)(32) })
    ))
  );
}
...
const LinkToCMSettingsView = ({
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPermissions, { permissions: permissionsToApply }, /* @__PURE__ */ react.createElement(
    Button/* Button */.z,
    {
...
const ListView = () => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/plugins/content-type-builder/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
