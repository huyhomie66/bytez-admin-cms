"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[9497],{
...
const ProfilePage = () => {
  ...
  const { setUserDisplayName } = (0,helper_plugin_esm.useAppInfo)();
  ...
  const submitMutation = (0,es.useMutation)((body) => putUser(body), {
    async onSuccess(data2) {
      ...
      helper_plugin_esm.auth.setUserInfo(
    ...
    ({ errors, values, handleChange, isSubmitting }) => {
      return /* @__PURE__ */ react.createElement(helper_plugin_esm.Form, null, /* @__PURE__ */ react.createElement(
        HeaderLayout/* HeaderLayout */.T,
        {
          ...
          primaryAction: /* @__PURE__ */ react.createElement(Button/* Button */.z, { startIcon: /* @__PURE__ */ react.createElement(Check["default"], null), loading: isSubmitting, type: "submit" }, formatMessage({ id: "global.save", defaultMessage: "Save" }))
        }
