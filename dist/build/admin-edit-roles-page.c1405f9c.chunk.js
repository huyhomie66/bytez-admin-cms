(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[2544],{
...
const schema = es/* object */.Ry().shape({
  name: es/* string */.Z_().required(helper_plugin_esm.translatedErrors.required),
  description: es/* string */.Z_().required(helper_plugin_esm.translatedErrors.required)
});
...
const CreatePage = () => {
  ...
  const { post, put } = (0,helper_plugin_esm.useFetchClient)();
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "Roles" }), /* @__PURE__ */ react.createElement(
    ...
    ({ handleSubmit, values, errors, handleReset, handleChange }) => /* @__PURE__ */ react.createElement(helper_plugin_esm.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
      HeaderLayout/* HeaderLayout */.T,
      {
        ...
        navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/settings/roles" }, formatMessage({
          id: "global.back",
          defaultMessage: "Back"
        }))
      }
    ...
    )) : /* @__PURE__ */ react.createElement(Box/* Box */.x, { background: "neutral0", padding: 6, shadow: "filterShadow", hasRadius: true }, /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null))))))
  ));
};
/* harmony default export */ function Roles_CreatePage() {
  return /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: permissions/* default */.Z.settings.roles.create }, /* @__PURE__ */ react.createElement(CreatePage, null));
}
...
const CarretIcon = (0,styled_components_browser_esm["default"])(CarretDown/* default */.Z)`
  display: none;
  width: ${10 / 16}rem;
...
const Cell = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  ...
  position: relative;
`;
const Chevron = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  display: none;
  svg {
    width: 11px;
  }
...
`;
const AbsoluteBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: absolute;
  right: 9px;
...
const SubActionRow_Cell = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: ${cellWidth};
  position: relative;
`;
const RowWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  height: ${rowHeight};
`;
const SubActionRow_Wrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  padding-left: ${31 / 16}rem;
`;
const LeftBorderTimeline = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border-left: ${({ isVisible, theme }) => isVisible ? `4px solid ${theme.colors.primary200}` : "4px solid transparent"};
`;
const RowStyle = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
const ActionRow_Cell = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: ${cellWidth};
  position: relative;
`;
const ActionRow_Wrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  height: ${rowHeight};
  flex: 1;
...
const CenteredStack = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: ${cellWidth};
  flex-shrink: 0;
`;
...
const Permissions = (0,react.forwardRef)(({ layout, isFormDisabled, permissions }, ref) => {
  ...
  (0,react.useImperativeHandle)(ref, () => {
    return {
      getPermissions() {
        const collectionTypesDiff = (0,helper_plugin_esm.difference)(
          initialData.collectionTypes,
          modifiedData.collectionTypes
        );
        const singleTypesDiff = (0,helper_plugin_esm.difference)(initialData.singleTypes, modifiedData.singleTypes);
...
const ProtectedEditPage = () => {
  const permissions = (0,react.useMemo)(() => {
    return {
      read: src_permissions/* default */.Z.settings.roles.read,
      update: src_permissions/* default */.Z.settings.roles.update
    };
  }, []);
  const {
    isLoading,
...
const v = ({ theme: r, expanded: o, variant: t, disabled: i, error: a }) => a ? `1px solid ${r.colors.danger600} !important` : i ? `1px solid ${r.colors.neutral150}` : o ? `1px solid ${r.colors.primary600}` : t === "primary" ? `1px solid ${r.colors.neutral0}` : `1px solid ${r.colors.neutral100}`, j = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(_Typography_Typography_js__WEBPACK_IMPORTED_MODULE_3__/* .Typography */ .Z)``, k = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(_Box_Box_js__WEBPACK_IMPORTED_MODULE_4__/* .Box */ .x)`
  border: ${v};
...
const L = (0,styled_components_browser_esm["default"])(TextButton/* TextButton */.A)`
  text-align: left;
...
`, P = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
