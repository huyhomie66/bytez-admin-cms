(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[5895],{
...
const PendingLogoDialog = ({ onClose, asset, prev, next, goTo, setLocalImage, onChangeLogo }) => {
  ...
  }))), /* @__PURE__ */ react.createElement(Box/* Box */.x, { maxWidth: (0,helper_plugin_esm.pxToRem)(180) }, asset.url ? /* @__PURE__ */ react.createElement(LogoModalStepper_ImageCardAsset, { asset }) : null)), /* @__PURE__ */ react.createElement(
    ModalFooter/* ModalFooter */.m,
    {
      startActions: /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: onClose, variant: "tertiary" }, formatMessage({
        id: "Settings.application.customization.modal.cancel",
...
const prefixAllUrls = (data) => transform_default()(
  ...
  (result, value, key) => {
    if (value && value.url) {
      result[key] = { ...value, url: (0,helper_plugin_esm.prefixFileUrlWithBackendUrl)(value.url) };
    } else {
      result[key] = value;
    }
  },
...
const defaultRoutes = [
  ...
  {
    async Component() {
      const component = await __webpack_require__.e(/* import() | admin-users */ 5199).then(__webpack_require__.bind(__webpack_require__, 88587));
      return component;
    },
    to: "/settings/users",
    exact: true
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__/* .GridItem */ .P, { col: 6, s: 12 }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_5__/* .Typography */ .Z, { variant: "sigma", textColor: "neutral600" }, formatMessage({
    ...
    /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      _strapi_design_system__WEBPACK_IMPORTED_MODULE_8__/* .Icon */ .J,
      {
        ...
        color: "danger500",
        as: _strapi_icons__WEBPACK_IMPORTED_MODULE_9__["default"]
      }
    )
  )), /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
...
const e = `${232 / 16}rem`, s = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_Grid_Grid_js__WEBPACK_IMPORTED_MODULE_2__/* .Grid */ .r)`
  width: ${e};
...
const l = (0,styled_components_browser_esm["default"])(Divider/* Divider */.i)`
  width: ${24 / 16}rem;
...
const h = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(_Box_Box_js__WEBPACK_IMPORTED_MODULE_3__/* .Box */ .x)`
  display: flex;
  align-items: center;
...
`, a = (0,styled_components__WEBPACK_IMPORTED_MODULE_2__["default"])(_strapi_icons__WEBPACK_IMPORTED_MODULE_5__/* ["default"] */ .Z)`
  width: ${12 / 16}rem;
  height: ${4 / 16}rem;
  * {
    fill: ${({ theme: r, $active: i }) => i ? r.colors.primary600 : r.colors.neutral600};
  }
`, y = styled_components__WEBPACK_IMPORTED_MODULE_2__["default"].div`
  svg {
    height: ${12 / 16}rem;
    width: ${12 / 16}rem;
  }
...
const a = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  border: none;
  padding: 0;
  background: transparent;
`, g = styled_components_browser_esm["default"].div`
  display: flex;
  align-items: center;
