(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[994],{
...
var helper_plugin_esm = __webpack_require__(73599);
...
function useSelect(name) {
  ...
  } = (0,helper_plugin_esm.useCMEditViewDataManager)();
...
const LabelAction = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  svg path {
...
const IconWrapper = styled_components_browser_esm["default"].span`
  > svg {
    width: ${(0,helper_plugin_esm.pxToRem)(24)};
    height: ${(0,helper_plugin_esm.pxToRem)(24)};
    > circle {
...
const CustomIconButton = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
  padding: ${({ theme }) => theme.spaces[2]};
...
`;
const MainButtons = (0,styled_components_browser_esm["default"])(IconButton/* IconButtonGroup */.o)`
  margin-left: ${({ theme }) => theme.spaces[4]};
`;
const MoreButton = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
...
`;
const IconButtonGroupMargin = (0,styled_components_browser_esm["default"])(IconButton/* IconButtonGroup */.o)`
...
`;
const ExpandButton = (0,styled_components_browser_esm["default"])(BaseButton/* BaseButton */.Y)`
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { padding: 2, background: "neutral100", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(StyledFlex, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(IconButtonGroupMargin, null, /* @__PURE__ */ react.createElement(
      ...
      CustomLinkIconButton,
      {
        ...
        label: "Link",
        name: "Link",
        icon: /* @__PURE__ */ react.createElement(Link["default"], null)
      }
    ), /* @__PURE__ */ react.createElement(
      CustomIconButton,
      {
...
const StyledFlex = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
const ExpandWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  background: ${({ theme }) => setOpacity(theme.colors.neutral800, 0.2)};
`;
const BoxWithBorder = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border-right: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
const EditorLayout_ExpandButton = (0,styled_components_browser_esm["default"])(BaseButton/* BaseButton */.Y)`
  background-color: transparent;
  border: none;
  align-items: center;
...
const EditorLayout = ({ children, isExpandMode, error, previewContent, onCollapse }) => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  (0,helper_plugin_esm.useLockScroll)(isExpandMode);
  if (isExpandMode) {
    return /* @__PURE__ */ react.createElement(Portal/* Portal */.h, { role: "dialog", "aria-modal": false }, /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: onCollapse }, /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { height: "100%", alignItems: "flex-start" }, /* @__PURE__ */ react.createElement(BoxWithBorder, { flex: "1", height: "100%" }, children), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "start", direction: "column", flex: 1, height: "100%", width: "100%" }, /* @__PURE__ */ react.createElement(
          Flex/* Flex */.k,
          {
            height: (0,helper_plugin_esm.pxToRem)(48),
            background: "neutral100",
...
const Wysiwyg_LabelAction = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  svg path {
    fill: ${({ theme }) => theme.colors.neutral500};
  }
`;
const TypographyAsterisk = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
  line-height: 0;
`;
const Wysiwyg_Wysiwyg = ({
  ...
  const { components } = (0,helper_plugin_esm.useLibrary)();
  ...
  const handleSelectAssets = (files) => {
    const formattedFiles = files.map((f) => ({
      ...
      url: (0,helper_plugin_esm.prefixFileUrlWithBackendUrl)(f.url),
      mime: f.mime
    }));
...
`;
const TextValidation = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  svg {
    height: ${12 / 16}rem;
    width: ${12 / 16}rem;
...
`;
const LoadingWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
const InputUID = ({
  ...
  const { modifiedData, initialData, layout } = (0,helper_plugin_esm.useCMEditViewDataManager)();
  ...
  return /* @__PURE__ */ react.createElement(
    TextInput/* TextInput */.o,
    {
      ...
      endAction: /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { position: "relative", gap: 1 }, availability && !regenerateLabel && /* @__PURE__ */ react.createElement(
        ...
        availability?.isAvailable ? /* @__PURE__ */ react.createElement(CheckCircle/* default */.Z, null) : /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null),
        /* @__PURE__ */ react.createElement(
          Typography/* Typography */.Z,
          {
...
var index_esm = __webpack_require__(84356);
...
const FlexWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: 100%;
...
`;
const ChildrenWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  width: 100%;
  /* Used to prevent endAction to be pushed out of container */
  min-width: 0;
`;
...
const ShadowBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: relative;
  overflow-x: hidden;
  overflow-y: auto;
...
const StyledBullet = styled_components_browser_esm["default"].div`
  flex-shrink: 0;
  width: ${(0,helper_plugin_esm.pxToRem)(6)};
  height: ${(0,helper_plugin_esm.pxToRem)(6)};
  margin-right: ${({ theme }) => theme.spaces[2]};
...
const LinkEllipsis = (0,styled_components_browser_esm["default"])(Link_Link/* Link */.r)`
  display: block;
  ...
  return /* @__PURE__ */ react.createElement(
    RelationItem,
    {
      ...
      endAction: /* @__PURE__ */ react.createElement(
        ...
        /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { width: "12px", as: Cross["default"] })
      ),
...
const useRelation = (cacheKey, { relation, search }) => {
  ...
  const onLoadRelationsCallback = (0,helper_plugin_esm.useCallbackRef)(onLoadRelations);
  (0,react.useEffect)(() => {
...
const RelationInputDataManager = ({
  ...
  if (!isFieldAllowed && isCreatingEntry || !isCreatingEntry && !isFieldAllowed && !isFieldReadable) {
    return /* @__PURE__ */ react.createElement(helper_plugin_esm.NotAllowedInput, { name, intlLabel, labelAction });
  }
...
function Inputs({
  ...
  const { fields } = (0,helper_plugin_esm.useLibrary)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  ...
  if (!shouldDisplayNotAllowedInput) {
    return /* @__PURE__ */ react.createElement(
      helper_plugin_esm.NotAllowedInput,
      {
...
const useLazyComponents = (componentUids = []) => {
  ...
  const customFieldsRegistry = (0,helper_plugin_esm.useCustomFields)();
  (0,react.useEffect)(() => {
...
const Component_CustomIconButton = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
  background-color: transparent;
...
`;
const ActionsFlex = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  & .drag-handle {
    background: unset;
...
const DraggedItem = ({
  ...
  const { modifiedData, removeRepeatableField, triggerFormValidation } = (0,helper_plugin_esm.useCMEditViewDataManager)();
...
const Footer = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  overflow: hidden;
...
`;
const Content = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border-bottom: none;
...
const TextButtonCustom = (0,styled_components_browser_esm["default"])(TextButton/* TextButton */.A)`
  height: 100%;
  width: 100%;
...
const RepeatableComponent = ({
  ...
  const { addRepeatableComponentToField, formErrors, moveComponentField } = (0,helper_plugin_esm.useCMEditViewDataManager)();
  const toggleNotification = (0,helper_plugin_esm.useNotification)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  ...
  ))), /* @__PURE__ */ react.createElement(Footer, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center", height: "48px", background: "neutral0" }, /* @__PURE__ */ react.createElement(TextButtonCustom, { disabled: isReadOnly, onClick: handleClick, startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null) }, formatMessage({
...
const FieldComponent = ({
  ...
  if (!hasChildrenAllowedFields && isCreatingEntry) {
    return /* @__PURE__ */ react.createElement(helper_plugin_esm.NotAllowedInput, { labelAction, intlLabel, name });
  }
...
const DynamicComponent_ActionsFlex = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  /* 
...
`;
const IconButtonCustom = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
  background-color: transparent;
...
`;
const AccordionContentRadius = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border-radius: 0 0 ${({ theme }) => theme.spaces[1]} ${({ theme }) => theme.spaces[1]};
`;
const Rectangle = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
...
const DynamicComponent_Preview = styled_components_browser_esm["default"].span`
  ...
  padding: ${({ theme }) => theme.spaces[6]};
`;
const ComponentContainer = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  list-style: none;
  padding: 0;
  margin: 0;
`;
const DynamicZoneComponent = ({
  ...
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { getComponentLayout } = (0,hooks/* useContentTypeLayout */.PL)();
  const { modifiedData } = (0,helper_plugin_esm.useCMEditViewDataManager)();
  ...
  const accordionActions = !isFieldAllowed ? null : /* @__PURE__ */ react.createElement(DynamicComponent_ActionsFlex, { gap: 0, expanded: isOpen }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Trash["default"], null)
  ), /* @__PURE__ */ react.createElement(
    IconButton/* IconButton */.h,
    {
      forwardedAs: "div",
...
const StyledAddIcon = (0,styled_components_browser_esm["default"])(PlusCircle/* default */.Z)`
...
`;
const StyledButton = (0,styled_components_browser_esm["default"])(BaseButton/* BaseButton */.Y)`
  border-radius: 26px;
...
`;
const BoxFullHeight = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  height: 100%;
`;
...
const DynamicZoneLabel_StyledBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border-radius: ${(0,helper_plugin_esm.pxToRem)(26)};
`;
const DynamicZoneLabel = ({
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", justifyContent: "center" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { maxWidth: (0,helper_plugin_esm.pxToRem)(356) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", fontWeight: "bold", ellipsis: true }, intlLabel, "\xA0"), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", fontWeight: "bold" }, "(", numberOfComponents, ")"), required && /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "danger600" }, "*"), labelAction && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 1 }, labelAction)), intlDescription && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1, maxWidth: (0,helper_plugin_esm.pxToRem)(356) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "pi", textColor: "neutral600", ellipsis: true }, formatMessage(intlDescription))))
  )));
};
...
const WIDTH_S = 5;
const WIDTH_M = 8;
const ComponentIcon_Wrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
const ComponentBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  flex-shrink: 0;
  height: ${(0,helper_plugin_esm.pxToRem)(84)};
  border: 1px solid ${({ theme }) => theme.colors.neutral200};
...
const CollectionTypeFormWrapper = ({ allLayoutData, children, slug, id, origin }) => {
  ...
  const toggleNotification = (0,helper_plugin_esm.useNotification)();
  const { setCurrentStep } = (0,helper_plugin_esm.useGuidedTour)();
  const { trackUsage } = (0,helper_plugin_esm.useTracking)();
  const { push, replace } = (0,react_router/* useHistory */.k6)();
  const [{ rawQuery }] = (0,helper_plugin_esm.useQueryParams)();
  ...
  const { formatAPIError } = (0,helper_plugin_esm.useAPIErrorHandler)(utils/* getTrad */.OB);
  ...
  const cleanClonedData = (0,react.useCallback)(
    (data2) => {
      ...
      const cleaned = (0,helper_plugin_esm.contentManagementUtilRemoveFieldsFromData)(
        data2,
  ...
  const cleanReceivedData = (0,react.useCallback)((data2) => {
    ...
    return (0,helper_plugin_esm.formatContentTypeData)(
      cleaned,
      allLayoutDataRef.current.contentType,
      allLayoutDataRef.current.components
    );
  ...
  (0,react.useEffect)(() => {
    const componentsDataStructure2 = Object.keys(allLayoutData.components).reduce((acc, current) => {
      ...
      acc[current] = (0,helper_plugin_esm.formatContentTypeData)(
    ...
    const contentTypeDataStructureFormatted = (0,helper_plugin_esm.formatContentTypeData)(
...
yup_es/* addMethod */.kM(yup_es/* mixed */.nK, "defined", function() {
  return this.test("defined", helper_plugin_esm.translatedErrors.required, (value) => value !== void 0);
});
yup_es/* addMethod */.kM(yup_es/* array */.IX, "notEmptyMin", function(min) {
  return this.test("notEmptyMin", helper_plugin_esm.translatedErrors.min, (value) => {
      ...
      if (attribute.type === "component") {
        ...
        if (attribute.repeatable === true) {
          ...
          let componentSchema2 = yup_es/* lazy */.Vo((value) => {
            ...
            if (min) {
              if (required) {
                baseSchema = baseSchema.min(min, helper_plugin_esm.translatedErrors.min);
              ...
              baseSchema = baseSchema.min(1, helper_plugin_esm.translatedErrors.required);
            }
            if (max) {
              baseSchema = baseSchema.max(max, helper_plugin_esm.translatedErrors.max);
            }
            return baseSchema;
          });
      ...
      if (attribute.type === "dynamiczone") {
        ...
        if (min) {
          if (attribute.required) {
            dynamicZoneSchema = dynamicZoneSchema.test("min", helper_plugin_esm.translatedErrors.min, (value) => {
            ...
            }).test("required", helper_plugin_esm.translatedErrors.required, (value) => {
              if (options.isCreatingEntry) {
          ...
          dynamicZoneSchema = dynamicZoneSchema.test("required", helper_plugin_esm.translatedErrors.required, (value) => {
            if (options.isCreatingEntry) {
              return value !== null || value !== void 0;
            }
            if (value === void 0) {
        ...
        if (max) {
          dynamicZoneSchema = dynamicZoneSchema.max(max, helper_plugin_esm.translatedErrors.max);
        }
...
const createYupSchemaAttribute = (type, validations, options) => {
  ...
  if (type === "json") {
    schema = yup_es/* mixed */.nK(helper_plugin_esm.translatedErrors.json).test("isJSON", helper_plugin_esm.translatedErrors.json, (value) => {
    ...
    }).nullable().test("required", helper_plugin_esm.translatedErrors.required, (value) => {
  ...
  if (type === "email") {
    schema = schema.email(helper_plugin_esm.translatedErrors.email);
  }
  ...
  Object.keys(validations).forEach((validation) => {
    ...
    if (!!validationValue || !isBoolean_default()(validationValue) && Number.isInteger(Math.floor(validationValue)) || validationValue === 0) {
      switch (validation) {
        case "required": {
          if (!options.isDraft) {
            if (type === "password" && options.isCreatingEntry) {
              schema = schema.required(helper_plugin_esm.translatedErrors.required);
            }
            if (type !== "password") {
              if (options.isCreatingEntry) {
                schema = schema.required(helper_plugin_esm.translatedErrors.required);
              } else {
                schema = schema.test("required", helper_plugin_esm.translatedErrors.required, (value) => {
        ...
        case "max": {
          if (type === "biginteger") {
            schema = schema.isInferior(helper_plugin_esm.translatedErrors.max, validationValue);
          } else {
            schema = schema.max(validationValue, helper_plugin_esm.translatedErrors.max);
          }
          break;
        }
        case "maxLength":
          schema = schema.max(validationValue, helper_plugin_esm.translatedErrors.maxLength);
          break;
        case "min": {
          if (type === "biginteger") {
            schema = schema.isSuperior(helper_plugin_esm.translatedErrors.min, validationValue);
          } else {
            schema = schema.min(validationValue, helper_plugin_esm.translatedErrors.min);
          }
          break;
        }
        case "minLength": {
          if (!options.isDraft) {
            schema = schema.min(validationValue, helper_plugin_esm.translatedErrors.minLength);
          }
          break;
        }
        case "regex":
          schema = schema.matches(new RegExp(validationValue), {
            message: helper_plugin_esm.translatedErrors.regex,
...
const EditViewDataManagerProvider = ({
  ...
  const checkFormErrors = (0,react.useCallback)(
    async (dataToSet = {}) => {
      ...
      try {
        ...
        errors = (0,helper_plugin_esm.getYupInnerErrors)(err);
        if (modifiedDZName) {
  ...
  const handleSubmit = (0,react.useCallback)(
    async (e) => {
      ...
      try {
        ...
        errors = {
          ...errors,
          ...(0,helper_plugin_esm.getAPIInnerErrors)(err, { getTrad: utils/* getTrad */.OB })
        };
      }
      dispatch({
        type: "SET_FORM_ERRORS",
  ...
  return /* @__PURE__ */ react.createElement(
    helper_plugin_esm.ContentManagerEditViewDataManagerContext.Provider,
    {
      value: {
        addComponentToDynamicZone,
        addNonRepeatableComponentToField,
    ...
    isLoadingForData || !isCreatingEntry && !initialData.id ? /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null)) : /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
...
const SingleTypeFormWrapper = ({ allLayoutData, children, slug }) => {
  ...
  const [{ query, rawQuery }] = (0,helper_plugin_esm.useQueryParams)();
  ...
  const cleanReceivedData = (0,react.useCallback)(
    (data2) => {
      ...
      return (0,helper_plugin_esm.formatContentTypeData)(cleaned, allLayoutData.contentType, allLayoutData.components);
    },
    [allLayoutData]
  );
  (0,react.useEffect)(() => {
...
function DraftAndPublishBadge_utils_select_useSelect() {
  const { initialData, hasDraftAndPublish } = (0,helper_plugin_esm.useCMEditViewDataManager)();
...
const CustomBullet = (0,styled_components_browser_esm["default"])(Dot/* default */.Z)`
  width: ${(0,helper_plugin_esm.pxToRem)(6)};
  height: ${(0,helper_plugin_esm.pxToRem)(6)};
  * {
...
const FlexTextAlign = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  text-align: center;
`;
const Header = ({
  ...
  if (isCreatingEntry && canCreate) {
    primaryAction = /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 2 }, hasDraftAndPublish && /* @__PURE__ */ react.createElement(Button/* Button */.z, { disabled: true, startIcon: /* @__PURE__ */ react.createElement(Check["default"], null), variant: "secondary" }, formatMessage({ id: "app.utils.publish", defaultMessage: "Publish" })), /* @__PURE__ */ react.createElement(Button/* Button */.z, { disabled: !didChangeData, loading: status === "submit-pending", type: "submit" }, formatMessage({
  ...
  if (!isCreatingEntry && canUpdate) {
    ...
    primaryAction = /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, shouldShowPublishButton && /* @__PURE__ */ react.createElement(
      Button/* Button */.z,
      {
        ...
        onClick,
        startIcon: /* @__PURE__ */ react.createElement(Check["default"], null),
        variant: "secondary"
      },
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(DialogBody/* DialogBody */.a, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center", style: { textAlign: "center" } }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { id: "confirm-description" }, formatMessage(
      {
    ...
    /* @__PURE__ */ react.createElement(DialogBody/* DialogBody */.a, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(FlexTextAlign, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { id: "confirm-description" }, draftCount, formatMessage(
      {
...
const getFieldsActionMatchingPermissions = (userPermissions, slug) => {
  const getMatchingPermissions = (action) => {
    const matched = (0,helper_plugin_esm.findMatchingPermissions)(userPermissions, [
      {
...
function DeleteLink_utils_select_useSelect() {
  const { hasDraftAndPublish, modifiedData } = (0,helper_plugin_esm.useCMEditViewDataManager)();
  let trackerProperty = {};
  if (hasDraftAndPublish) {
...
const DeleteLink = ({ onDelete, trackerProperty }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Button/* Button */.z, { onClick: toggleWarningDelete, size: "S", startIcon: /* @__PURE__ */ react.createElement(Trash["default"], null), variant: "danger-light" }, formatMessage({
...
const Permissions = (props) => {
  ...
  const { isLoading, allowedActions } = (0,helper_plugin_esm.useRBAC)(viewPermissions, props.userPermissions);
  if (isLoading) {
...
const EditViewLayoutManager = ({ layout, ...rest }) => {
  ...
  const { runHookWaterfall } = (0,helper_plugin_esm.useStrapiApp)();
...
const CustomLink = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
const FieldButtonContent_CustomIconButton = (0,styled_components_browser_esm["default"])(IconButton/* IconButton */.h)`
  background-color: transparent;
  path {
    fill: ${({ theme }) => theme.colors.neutral600};
  }
...
const DisplayedFieldButton_Wrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  position: relative;
...
`;
const CustomDragIcon = (0,styled_components_browser_esm["default"])(Drag/* default */.Z)`
  height: ${12 / 16}rem;
  width: ${12 / 16}rem;
  path {
    fill: ${({ theme }) => theme.colors.neutral600};
...
`;
const CustomFlex = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
`;
const DragButton = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  cursor: all-scroll;
  border-right: 1px solid ${({ theme }) => theme.colors.neutral200};
`;
...
const LinkToCTB = () => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPermissions, { permissions: LinkToCTB_permissions }, /* @__PURE__ */ react.createElement(
...
const HeaderContainer = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  svg {
    width: ${32 / 16}rem;
    height: ${24 / 16}rem;
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
      ...
      helper_plugin_esm.ConfirmDialog,
      {
        ...
        iconRightButton: /* @__PURE__ */ react.createElement(Check["default"], null),
...
const FileWrapper_Wrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  position: relative;
  border-radius: 50%;
  width: 26px;
  height: 26px;
...
const Media_Media = ({ url, mime, alternativeText, name, ext, formats }) => {
  const fileURL = (0,helper_plugin_esm.prefixFileUrlWithBackendUrl)(url);
  if (mime.includes("image")) {
    const thumbnail = formats?.thumbnail?.url || null;
    const mediaURL = (0,helper_plugin_esm.prefixFileUrlWithBackendUrl)(thumbnail) || fileURL;
    return /* @__PURE__ */ react.createElement(Avatar/* Avatar */.q, { src: mediaURL, alt: alternativeText || name, preview: true });
  }
  const fileExtension = (0,helper_plugin_esm.getFileExtension)(ext);
...
const RelationMultiple = ({ fieldSchema, metadatas, name, entityId, value, contentType }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { ...helper_plugin_esm.stopPropagation }, /* @__PURE__ */ react.createElement(
    SimpleMenu/* SimpleMenu */.O,
    {
      label: Label,
      size: "S",
...
const RelationSingle_TypographyMaxWidth = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
  max-width: 500px;
`;
...
const RepeatableComponent_TypographyMaxWidth = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
  max-width: 500px;
`;
...
const SingleComponent_TypographyMaxWidth = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
  max-width: 250px;
`;
...
const CellContent_TypographyMaxWidth = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
  max-width: 300px;
`;
...
const TableRows = ({
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data, index) => {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      withMainAction && /* @__PURE__ */ react.createElement(Cell.Td, { ...helper_plugin_esm.stopPropagation }, /* @__PURE__ */ react.createElement(
      ...
      withBulkActions && /* @__PURE__ */ react.createElement(Cell.Td, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "end", ...helper_plugin_esm.stopPropagation }, /* @__PURE__ */ react.createElement(
        IconButton/* IconButton */.h,
        {
          forwardedAs: react_router_dom.Link,
          onClick: () => {
...
const ConfirmDialogDeleteAll = ({ isConfirmButtonLoading, isOpen, onToggleDialog, onConfirm }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(DialogBody/* DialogBody */.a, { icon: /* @__PURE__ */ react.createElement(ExclamationMarkCircle["default"], null) }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "stretch", gap: 2 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { id: "confirm-description" }, formatMessage({
...
const useAllowedAttributes = (contentType, slug) => {
  const { allPermissions } = (0,helper_plugin_esm.useRBACProvider)();
  const readPermissionsForSlug = (0,helper_plugin_esm.findMatchingPermissions)(allPermissions, [
    {
...
const Filters = ({ displayedFilters }) => {
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 1, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(
    ...
    helper_plugin_esm.FilterPopoverURLQuery,
    {
      displayedFilters,
      isVisible,
  ...
  )), /* @__PURE__ */ react.createElement(helper_plugin_esm.FilterListURLQuery, { filtersSchema: displayedFilters }));
};
Filters.propTypes = {
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.PageSizeURLQuery, { trackedEvent: "willChangeNumberOfEntriesPerPage" }), /* @__PURE__ */ react.createElement(helper_plugin_esm.PaginationURLQuery, { pagination })));
};
...
const ListView_cmPermissions = permissions/* default */.Z.contentManager;
const ConfigureLayoutBox = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  svg {
    path {
...
function ListView({
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: "/content-manager/" }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      }))
    }
  ...
  ), /* @__PURE__ */ react.createElement(ListView_PaginationFooter, { pagination: { pageCount: pagination?.pageCount || 1 } })) : /* @__PURE__ */ react.createElement(helper_plugin_esm.NoPermissions, null)));
}
ListView.propTypes = {
  canCreate: (prop_types_default()).bool.isRequired,
...
const Permissions_Permissions = (props) => {
  const viewPermissions = (0,react.useMemo)(() => (0,utils/* generatePermissionsObject */.TA)(props.slug), [props.slug]);
  const { isLoading, allowedActions } = (0,helper_plugin_esm.useRBAC)(viewPermissions, props.permissions);
  if (isLoading) {
    return /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null);
  }
...
/* harmony default export */ const ListViewLayoutManager_Permissions = ((0,react.memo)(Permissions_Permissions, (prev, next) => {
  const differenceBetweenRerenders = (0,helper_plugin_esm.difference)(prev, next);
...
const ActionBox = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
`;
const FieldContainer = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  border: 1px solid
    ${({ theme, isSibling }) => isSibling ? theme.colors.neutral150 : theme.colors.primary200};
...
`;
const CardDragPreview_TypographyMaxWidth = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
  max-width: ${72 / 16}rem;
`;
function CardDragPreview({ labelField, transparent, isSibling }) {
  return /* @__PURE__ */ react.createElement(
    FieldContainer,
    {
      ...
      transparent,
      isSibling,
      "max-height": (0,helper_plugin_esm.pxToRem)(32),
    ...
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(ActionBox, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Pencil/* default */.Z, null)), /* @__PURE__ */ react.createElement(ActionBox, { alignItems: "center" }, /* @__PURE__ */ react.createElement(Cross["default"], null)))
  );
}
...
`;
const DraggableCard_FieldContainer = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
...
`;
const FieldWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  &:last-child {
...
const SortDisplayedFields_FlexWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  flex: ${({ size }) => size};
`;
...
const EditFieldForm_HeaderContainer = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  svg {
    width: ${32 / 16}rem;
    height: ${24 / 16}rem;
    margin-right: ${({ theme }) => theme.spaces[3]};
...
const ListSettingsView = ({ layout, slug }) => {
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isSubmittingForm }, /* @__PURE__ */ react.createElement("form", { onSubmit: handleSubmit }, /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: goBackUrl, id: "go-back" }, formatMessage({ id: "global.back", defaultMessage: "Back" })),
      primaryAction: /* @__PURE__ */ react.createElement(
        Button/* Button */.z,
        {
          size: "S",
...
const ErrorFallback = () => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { padding: 8 }, /* @__PURE__ */ react.createElement(helper_plugin_esm.AnErrorOccurred, null));
};
...
const CollectionTypeRecursivePath_cmPermissions = permissions/* default */.Z.contentManager;
const CollectionTypeRecursivePath = ({
  ...
  ))), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: `${url}/configurations/edit` }, /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: CollectionTypeRecursivePath_cmPermissions.collectionTypesConfigurations }, /* @__PURE__ */ react.createElement(
...
const ComponentSetttingsView_cmPermissions = permissions/* default */.Z.contentManager;
const ComponentSettingsView = () => {
  ...
  return /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: ComponentSetttingsView_cmPermissions.componentsConfigurations }, /* @__PURE__ */ react.createElement(pages_EditSettingsView, { components: layout.components, mainLayout: layout.component, slug: uid }));
};
...
const NoPermissions = () => {
  ...
  ), /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.NoPermissions, null)));
};
...
const SingleTypeRecursivePath_cmPermissions = permissions/* default */.Z.contentManager;
...
const LeftMenu = () => {
  ...
  const { startsWith } = (0,helper_plugin_esm.useFilter)(locale, {
    sensitivity: "base"
  });
  ...
  return /* @__PURE__ */ react.createElement(SubNav/* SubNav */.m, { ariaLabel: label }, /* @__PURE__ */ react.createElement(
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      section.links.map((link) => {
        ...
        return /* @__PURE__ */ react.createElement(SubNavLink/* SubNavLink */.E, { as: react_router_dom.NavLink, key: link.uid, to: `${link.to}${search2}` }, link.title);
      })
    );
  })));
};
...
const checkPermissions = (userPermissions, permissionsToCheck) => permissionsToCheck.map(({ permissions }) => (0,helper_plugin_esm.hasPermissions)(userPermissions, permissions));
...
const DropdownIconWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  border-radius: 50%;
...
function ComponentDragPreview({ displayedValue }) {
  return /* @__PURE__ */ react.createElement(
    ...
    ), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { maxWidth: (0,helper_plugin_esm.pxToRem)(150) }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { textColor: "neutral700", ellipsis: true }, displayedValue)))),
    /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 2 }, /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { noBorder: true }, /* @__PURE__ */ react.createElement(Trash["default"], null)), /* @__PURE__ */ react.createElement(IconButton/* IconButton */.h, { noBorder: true }, /* @__PURE__ */ react.createElement(Drag/* default */.Z, null)))
  );
}
...
const RelationDragPreview = ({ status, displayedValue, width }) => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { style: { width } }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingLeft: 4 }, /* @__PURE__ */ react.createElement(DisconnectButton, { type: "button" }, /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { width: "12px", as: Cross["default"] })))
  ));
};
...
const App_cmPermissions = permissions/* default */.Z.contentManager;
...
const App = () => {
  ...
  const { pathname } = (0,react_router/* useLocation */.TH)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { startSection } = (0,helper_plugin_esm.useGuidedTour)();
  ...
  if (status === "loading") {
    ...
    ), /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null));
  }
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, { sideNav: /* @__PURE__ */ react.createElement(App_LeftMenu, null) }, /* @__PURE__ */ react.createElement(DragLayer/* DragLayer */.r, { renderItem: renderDraglayerItem }), /* @__PURE__ */ react.createElement(contexts_ModelsContext.Provider, { value: { refetchData } }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "/content-manager/components/:uid/configurations/edit" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: App_cmPermissions.componentsConfigurations }, /* @__PURE__ */ react.createElement(ComponentSetttingsView, null))), /* @__PURE__ */ react.createElement(
    react_router/* Route */.AW,
    {
      path: "/content-manager/collectionType/:slug",
      component: pages_CollectionTypeRecursivePath
    }
  ), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "/content-manager/singleType/:slug", component: pages_SingleTypeRecursivePath }), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "/content-manager/403" }, /* @__PURE__ */ react.createElement(pages_NoPermissions, null)), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "/content-manager/no-content-types" }, /* @__PURE__ */ react.createElement(pages_NoContentType, null)), /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { path: "", component: helper_plugin_esm.AnErrorOccurred }))));
};
...
const Body = () => {
  ...
  const { initialData, isCreatingEntry } = (0,helper_plugin_esm.useCMEditViewDataManager)();
...
function InformationBoxCE() {
  return /* @__PURE__ */ react.createElement(Information/* default */.Z.Root, null, /* @__PURE__ */ react.createElement(Information/* default */.Z.Title, null), /* @__PURE__ */ react.createElement(Information/* default */.Z.Body, null));
}
...
function ReviewWorkflowsStageEE({ color, name }) {
  ...
  return /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "center", gap: 2, maxWidth: (0,helper_plugin_esm.pxToRem)(300) }, /* @__PURE__ */ react.createElement(
    Box/* Box */.x,
    {
      height: 2,
      background: color,
...
function InformationBoxEE() {
  ...
  const { formatAPIError } = (0,helper_plugin_esm.useAPIErrorHandler)();
  const toggleNotification = (0,helper_plugin_esm.useNotification)();
  const { workflows, isLoading: workflowIsLoading } = (0,useReviewWorkflows/* useReviewWorkflows */.n)();
  ...
  ), /* @__PURE__ */ react.createElement(FieldError/* FieldError */.c, null))), /* @__PURE__ */ react.createElement(Information/* default */.Z.Body, null));
}
