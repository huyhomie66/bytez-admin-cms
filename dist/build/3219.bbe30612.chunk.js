"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[3219],{
...
const schema = yup_es/* object */.Ry().shape({
  name: yup_es/* string */.Z_(helper_plugin_esm.translatedErrors.string).max(100).required(helper_plugin_esm.translatedErrors.required),
  description: yup_es/* string */.Z_().nullable(),
  lifespan: yup_es/* number */.Rx().integer().min(0).nullable().defined(helper_plugin_esm.translatedErrors.required),
  permissions: yup_es/* string */.Z_(helper_plugin_esm.translatedErrors.string).required(helper_plugin_esm.translatedErrors.required)
});
/* harmony default export */ const utils_schema = (schema);
...
const LoadingView = ({ transferTokenName }) => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
...
const TransferTokenCreateView = () => {
  ...
  } = (0,helper_plugin_esm.useRBAC)(permissions/* default */.Z.settings["transfer-tokens"]);
  const {
    params: { id }
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "Transfer Tokens" }), /* @__PURE__ */ react.createElement(
