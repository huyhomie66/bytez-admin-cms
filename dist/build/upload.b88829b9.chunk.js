"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[3650],{
...
const PaginationFooter = ({ pagination }) => {
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "flex-end", justifyContent: "space-between" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.PageSizeURLQuery, null), /* @__PURE__ */ react.createElement(helper_plugin_esm.PaginationURLQuery, { pagination })));
};
...
const BulkMoveDialog = ({ onClose, selected, currentFolder }) => {
  ...
  const handleSubmit = async (values, { setErrors }) => {
    try {
      ...
      const normalizedError = (0,helper_plugin_esm.normalizeAPIError)(error);
...
var Breadcrumbs = __webpack_require__(79422);
...
const Header = ({
  ...
  return /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      primaryAction: canCreate && /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { gap: 2 }, /* @__PURE__ */ react.createElement(Button/* Button */.z, { startIcon: /* @__PURE__ */ react.createElement(Plus["default"], null), variant: "secondary", onClick: onToggleEditFolderDialog }, formatMessage({
...
const MediaLibrary = () => {
  ...
  const [view, setView] = (0,helper_plugin_esm.usePersistentState)(constants/* localStorageKeys */.uf.view, constants/* viewOptions */.Uk.GRID);
  ...
  const [selected, { selectOne, selectAll }] = (0,helper_plugin_esm.useSelectionState)(["type", "id"], []);
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(
    ...
    ActionLayout/* ActionLayout */.Z,
    {
      ...
      endActions: /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPermissions, { permissions: permissions/* default */.Z.configureView }, /* @__PURE__ */ react.createElement(ActionContainer, { paddingTop: 1, paddingBottom: 1 }, /* @__PURE__ */ react.createElement(
  ...
  ), isLoading && /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null), (assetsError || foldersError) && /* @__PURE__ */ react.createElement(helper_plugin_esm.AnErrorOccurred, null), folderCount === 0 && assetCount === 0 && /* @__PURE__ */ react.createElement(
...
const Upload = () => {
  ...
  const [{ rawQuery }, setQuery] = (0,helper_plugin_esm.useQueryParams)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  ...
  (0,helper_plugin_esm.useFocusWhenNavigate)();
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(Helmet/* Helmet */.q, { title }), isLoading && /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null), rawQuery ? /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, /* @__PURE__ */ react.createElement(react_router/* Route */.AW, { exact: true, path: `/plugins/${pluginId/* default */.Z}`, component: MediaLibrary }), /* @__PURE__ */ react.createElement(
