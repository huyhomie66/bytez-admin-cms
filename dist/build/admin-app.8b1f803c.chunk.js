(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[5538],{
...
const ForgotPassword = ({ onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    ...
    ({ values, errors, handleChange }) => /* @__PURE__ */ react.createElement(helper_plugin_esm.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* Column */.sg, null, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6, paddingBottom: 7 }, /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha" }, formatMessage({
  ...
  )), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { to: "/auth/login" }, formatMessage({ id: "Auth.link.ready", defaultMessage: "Ready to sign in?" }))))));
};
...
const ForgotPasswordSuccess = () => {
  ...
  }))))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { to: "/auth/login" }, formatMessage({ id: "Auth.link.signin", defaultMessage: "Sign in" }))))));
};
...
const Oops = () => {
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const query = (0,helper_plugin_esm.useQuery)();
...
const Register = ({ authType, fieldsToDisable, noSignin, onSubmit, schema }) => {
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement(
    formik_esm/* Formik */.J9,
    {
      ...
      onSubmit: async (data, formik) => {
        ...
        try {
          ...
          const errors = (0,helper_plugin_esm.getYupInnerErrors)(err);
    ...
    ({ values, errors, handleChange }) => {
      return /* @__PURE__ */ react.createElement(helper_plugin_esm.Form, { noValidate: true }, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", alignItems: "center", gap: 3 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { as: "h1", variant: "alpha", textAlign: "center" }, formatMessage({
  ...
  ), !noSignin && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 4 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "center" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { label: "Auth.link.signin", to: "/auth/login" }, formatMessage({
...
var Login=function(){if(window&&window.strapi&&window.strapi.isEE){return (__webpack_require__(9442)/* ["default"] */ .Z);}return (__webpack_require__(73347)/* ["default"] */ .Z);}();var forms_forms={'forgot-password':{Component:components_ForgotPassword,endPoint:'forgot-password',fieldsToDisable:[],fieldsToOmit:[],schema:es/* object */.Ry().shape({email:es/* string */.Z_().email(helper_plugin_esm.translatedErrors.email).required(helper_plugin_esm.translatedErrors.required)}),inputsPrefix:''},'forgot-password-success':{Component:components_ForgotPasswordSuccess,endPoint:'',fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},login:{Component:Login,endPoint:'login',fieldsToDisable:[],fieldsToOmit:['rememberMe'],schema:es/* object */.Ry().shape({email:es/* string */.Z_().email(helper_plugin_esm.translatedErrors.email).required(helper_plugin_esm.translatedErrors.required),password:es/* string */.Z_().required(helper_plugin_esm.translatedErrors.required),rememberMe:es/* bool */.Xg().nullable()}),inputsPrefix:''},oops:{Component:components_Oops,endPoint:null,fieldsToDisable:[],fieldsToOmit:[],schema:null,inputsPrefix:''},register:{Component:components_Register,endPoint:'register',fieldsToDisable:['email'],fieldsToOmit:['userInfo.confirmPassword','userInfo.news','userInfo.email'],schema:es/* object */.Ry().shape({firstname:es/* string */.Z_().trim().required(helper_plugin_esm.translatedErrors.required),lastname:es/* string */.Z_(),password:es/* string */.Z_().min(8,helper_plugin_esm.translatedErrors.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm.translatedErrors.required),confirmPassword:es/* string */.Z_().oneOf([es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm.translatedErrors.required),registrationToken:es/* string */.Z_().required(helper_plugin_esm.translatedErrors.required)}),inputsPrefix:'userInfo.'},'register-admin':{Component:components_Register,endPoint:'register-admin',noSignin:true,fieldsToDisable:[],fieldsToOmit:['confirmPassword','news'],schema:es/* object */.Ry().shape({firstname:es/* string */.Z_().trim().required(helper_plugin_esm.translatedErrors.required),lastname:es/* string */.Z_(),password:es/* string */.Z_().min(8,helper_plugin_esm.translatedErrors.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm.translatedErrors.required),email:es/* string */.Z_().email(helper_plugin_esm.translatedErrors.email).strict().lowercase(helper_plugin_esm.translatedErrors.lowercase).required(helper_plugin_esm.translatedErrors.required),confirmPassword:es/* string */.Z_().oneOf([es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm.translatedErrors.required)}),inputsPrefix:''},'reset-password':{Component:ResetPassword,endPoint:'reset-password',fieldsToDisable:[],fieldsToOmit:['confirmPassword'],schema:es/* object */.Ry().shape({password:es/* string */.Z_().min(8,helper_plugin_esm.translatedErrors.minLength).matches(/[a-z]/,'components.Input.error.contain.lowercase').matches(/[A-Z]/,'components.Input.error.contain.uppercase').matches(/\d/,'components.Input.error.contain.number').required(helper_plugin_esm.translatedErrors.required),confirmPassword:es/* string */.Z_().oneOf([es/* ref */.iH('password'),null],'components.Input.error.password.noMatch').required(helper_plugin_esm.translatedErrors.required)})}};/* harmony default export */ const utils_forms = (forms_forms);
...
const PrivateRoute = ({ component: Component, path, ...rest }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    {
      path,
      render: (props) => helper_plugin_esm.auth.getToken() !== null ? /* @__PURE__ */ react.createElement(Component, { ...rest, ...props }) : /* @__PURE__ */ react.createElement(
...
if(!AuthPage_forms[authType]||hasAdmin&&authType==='register-admin'||helper_plugin_esm.auth.getToken()){return/*#__PURE__*/react.createElement(react_router/* Redirect */.l_,{to:"/"});}// Redirect the user to the register-admin if it is the first user
...
const UseCasePage = () => {
  ...
  const { firstname, email } = helper_plugin_esm.auth.getUserInfo();
  ...
  return /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* default */.ZP, null, /* @__PURE__ */ react.createElement(Main/* Main */.o, { labelledBy: "usecase-title" }, /* @__PURE__ */ react.createElement(UnauthenticatedLayout/* LayoutContent */.bU, null, /* @__PURE__ */ react.createElement("form", { onSubmit: (e) => handleSubmit(e, false) }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { direction: "column", paddingBottom: 7 }, /* @__PURE__ */ react.createElement(UnauthenticatedLogo/* default */.Z, null), /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 6, paddingBottom: 1, width: (0,helper_plugin_esm.pxToRem)(250) }, /* @__PURE__ */ react.createElement(TypographyCenter, { variant: "alpha", as: "h1", id: "usecase-title" }, formatMessage({
    id: "Usecase.title",
...
const AuthenticatedApp = (0,react.lazy)(
  () => Promise.all(/* import() | Admin-authenticatedApp */[__webpack_require__.e(6618), __webpack_require__.e(801)]).then(__webpack_require__.bind(__webpack_require__, 93858))
);
function App() {
  const toggleNotification = (0,helper_plugin_esm.useNotification)();
  ...
  const appInfo = (0,helper_plugin_esm.useAppInfo)();
  const { get, post } = (0,helper_plugin_esm.useFetchClient)();
  ...
  (0,react.useEffect)(() => {
    const currentToken = helper_plugin_esm.auth.getToken();
    const renewToken = async () => {
      try {
        ...
        helper_plugin_esm.auth.updateToken(token);
      } catch (err) {
        helper_plugin_esm.auth.clearAppStorage();
    ...
    const getData = async () => {
      try {
        ...
        updateProjectSettings({
          menuLogo: (0,helper_plugin_esm.prefixFileUrlWithBackendUrl)(menuLogo),
          authLogo: (0,helper_plugin_esm.prefixFileUrlWithBackendUrl)(authLogo)
        });
  ...
  return /* @__PURE__ */ react.createElement(react.Suspense, { fallback: /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null) }, /* @__PURE__ */ react.createElement(SkipToContent/* SkipToContent */.z, null, formatMessage({ id: "skipToContent" })), /* @__PURE__ */ react.createElement(helper_plugin_esm.TrackingProvider, { value: trackingInfo }, /* @__PURE__ */ react.createElement(react_router/* Switch */.rs, null, authRoutes, /* @__PURE__ */ react.createElement(
    react_router/* Route */.AW,
    {
      path: "/auth/:authType",
...
const GuidedTour = ({ children }) => {
  ...
  return /* @__PURE__ */ react.createElement(
    helper_plugin_esm.GuidedTourProvider,
    {
      guidedTourState,
      currentStep,
      setCurrentStep,
...
const Providers = ({
  ...
  return /* @__PURE__ */ react.createElement(components_ThemeToggleProvider, { themes }, /* @__PURE__ */ react.createElement(components_Theme, null, /* @__PURE__ */ react.createElement(es.QueryClientProvider, { client: queryClient }, /* @__PURE__ */ react.createElement(react_redux_es/* Provider */.zt, { store }, /* @__PURE__ */ react.createElement(contexts/* AdminContext */.ux.Provider, { value: { getAdminInjectedComponents } }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(
      helper_plugin_esm.StrapiAppProvider,
      {
        getPlugin,
        menu,
        plugins,
      ...
      /* @__PURE__ */ react.createElement(helper_plugin_esm.LibraryProvider, { components, fields }, /* @__PURE__ */ react.createElement(helper_plugin_esm.CustomFieldsProvider, { customFields }, /* @__PURE__ */ react.createElement(components_LanguageProvider, { messages, localeNames }, /* @__PURE__ */ react.createElement(helper_plugin_esm.AutoReloadOverlayBlockerProvider, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.OverlayBlockerProvider, null, /* @__PURE__ */ react.createElement(components_GuidedTour, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.NotificationsProvider, null, children)))))))
    )
  ))))));
};
Providers.propTypes = {
...
class StrapiApp {
  ...
  render() {
    ...
    return /* @__PURE__ */ react.createElement(
      ...
      ), /* @__PURE__ */ react.createElement(react_router_dom.BrowserRouter, { basename: basename/* default */.Z }, /* @__PURE__ */ react.createElement(pages_App, { store })))
    );
  }
}
...
/* harmony import */ var _hooks__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(95428);
...
// UNUSED EXPORTS: useContentTypes, useLicenseLimit, useLicenseLimitNotification, useReleaseNotification
...
/* harmony default export */ const useFetchPermissionsLayout_reducer = (reducer);
...
const useFetchPermissionsLayout = (id) => {
  const [{ data, error, isLoading }, dispatch] = (0,react.useReducer)(useFetchPermissionsLayout_reducer, initialState);
  const { get } = (0,helper_plugin_esm.useFetchClient)();
  (0,react.useEffect)(() => {
    const getData = async () => {
      try {
...
/* harmony default export */ const useFetchRole_reducer = (reducer_reducer);
...
const useFetchRole = (id) => {
  const toggleNotification = (0,helper_plugin_esm.useNotification)();
  const [state, dispatch] = (0,react.useReducer)(useFetchRole_reducer, reducer_initialState);
  const { get } = (0,helper_plugin_esm.useFetchClient)();
  (0,react.useEffect)(() => {
    if (id) {
  ...
  generalSectionLinks: [
    {
      ...
      to: "/list-plugins",
      permissions: permissions/* default */.Z.marketplace.main
    },
    {
...
const useMenu = () => {
  ...
  const { shouldUpdateStrapi } = (0,helper_plugin_esm.useAppInfo)();
  const { menu } = (0,helper_plugin_esm.useStrapiApp)();
...
const useRolesList = (shouldFetchData = true) => {
  ...
  const fetchRolesList = (0,react.useCallback)(async () => {
    const fetchClient = (0,helper_plugin_esm.getFetchClient)();
    try {
      dispatch({
        type: "GET_DATA"
      });
...
const defaultAdminLinks = [
  {
    ...
    id: "roles",
    isDisplayed: false,
    permissions: permissions/* default */.Z.settings.roles.main
  },
  {
    ...
    id: "users",
    isDisplayed: false,
    permissions: permissions/* default */.Z.settings.users.main
  }
];
...
const defaultGlobalLinks = [
  ...
  },
  {
    ...
    id: "webhooks",
    isDisplayed: false,
    permissions: permissions/* default */.Z.settings.webhooks.main
  },
  {
    ...
    id: "api-tokens",
    isDisplayed: false,
    permissions: permissions/* default */.Z.settings["api-tokens"].main
  },
  {
    ...
    id: "transfer-tokens",
    isDisplayed: false,
    permissions: permissions/* default */.Z.settings["transfer-tokens"].main
  }
];
...
const useSettingsMenu = (noCheck = false) => {
  const { allPermissions: permissions } = (0,helper_plugin_esm.useRBACProvider)();
  const { shouldUpdateStrapi } = (0,helper_plugin_esm.useAppInfo)();
  const { settings } = (0,helper_plugin_esm.useStrapiApp)();
  ...
  (0,react.useEffect)(() => {
    const getData = async () => {
      const checkPermissions = async (permissionsToCheck, path) => {
        const hasPermission = await (0,helper_plugin_esm.hasPermissions)(permissions, permissionsToCheck);
...
const FieldActionWrapper = (0,styled_components__WEBPACK_IMPORTED_MODULE_0__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_1__/* .FieldAction */ .E)`
  svg {
    height: 1rem;
    width: 1rem;
    path {
...
/* harmony export */ });
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(67294);
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(73599);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(1565);
/* harmony import */ var formik__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(14916);
...
const PasswordInput = (0,styled_components__WEBPACK_IMPORTED_MODULE_6__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_7__/* .TextInput */ .o)`
  ::-ms-reveal {
    display: none;
  }
`;
...
const NoContentType = () => {
  ...
  return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_3__/* .Main */ .o, { labelledBy: "title" }, /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
    ...
    {
      action: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.LinkButton, { variant: "secondary", endIcon: /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_icons__WEBPACK_IMPORTED_MODULE_7__["default"], null), to: "/" }, formatMessage({
...
/* harmony export */   Z: () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(73599);
/* harmony import */ var react_query__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(88767);
/* harmony import */ var _admin_src_permissions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(87751);



const useLicenseLimits = () => {
  const rbac = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__.useRBAC)(_admin_src_permissions__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z.settings.users);
  const {
    isLoading: isRBACLoading,
    allowedActions: { canRead, canCreate, canUpdate, canDelete }
  } = rbac;
  const isRBACAllowed = canRead && canCreate && canUpdate && canDelete;
  const { get } = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_0__.useFetchClient)();
  ...
  const license = (0,react_query__WEBPACK_IMPORTED_MODULE_1__.useQuery)(["ee", "license-limit-info"], fetchLicenseLimitInfo, {
...
const AuthResponse = () => {
  ...
  const fetchUserInfo = (0,react.useCallback)(async () => {
    try {
      ...
      helper_plugin_esm.auth.clearAppStorage();
      if (jwtToken) {
        helper_plugin_esm.auth.setToken(jwtToken, true);
        const requestUrl = (0,utils/* getRequestUrl */.IF)("users/me");
        const {
          data: { data }
        } = await get(requestUrl);
        helper_plugin_esm.auth.setUserInfo(data, true);
...
/* harmony import */ var styled_components__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(1565);
...
const DividerFull = (0,styled_components__WEBPACK_IMPORTED_MODULE_5__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_6__/* .Divider */ .i)`
  flex: 1;
`;
const Login = (loginProps) => {
...
`;
const SSOProvidersWrapper = (0,styled_components__WEBPACK_IMPORTED_MODULE_1__["default"])(_strapi_design_system__WEBPACK_IMPORTED_MODULE_2__/* .Flex */ .k)`
