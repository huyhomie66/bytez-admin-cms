"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[7027],{
...
const removePasswordFieldsFromData = (data, contentTypeSchema, componentSchema) => {
  const recursiveCleanData = (data2, schema) => {
    return Object.keys(data2).reduce((acc, current) => {
      const attrType = (0,helper_plugin_esm.getType)(schema, current);
      const value = get_default()(data2, current);
      const component = (0,helper_plugin_esm.getOtherInfos)(schema, [current, "component"]);
      const isRepeatable = (0,helper_plugin_esm.getOtherInfos)(schema, [current, "repeatable"]);
...
function useReviewWorkflows(params = {}) {
  ...
  const { get } = (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.useFetchClient)();
