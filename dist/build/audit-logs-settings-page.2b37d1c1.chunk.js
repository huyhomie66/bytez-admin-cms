"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[2812],{
...
const TableRows = ({ headers, rows, onOpenModal }) => {
  ...
  return /* @__PURE__ */ react.createElement(Tbody/* Tbody */.p, null, rows.map((data) => {
    return /* @__PURE__ */ react.createElement(
      ...
      /* @__PURE__ */ react.createElement(Cell.Td, { ...helper_plugin_esm.stopPropagation }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { justifyContent: "end" }, /* @__PURE__ */ react.createElement(
...
const ListView = () => {
  ...
  } = (0,helper_plugin_esm.useRBAC)(auditLogsPermissions);
  const [{ query }, setQuery] = (0,helper_plugin_esm.useQueryParams)();
  ...
  if (hasError) {
    return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 8 }, /* @__PURE__ */ react.createElement(helper_plugin_esm.AnErrorOccurred, null))));
  }
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": isLoading }, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: title }), /* @__PURE__ */ react.createElement(
    ...
    helper_plugin_esm.DynamicTable,
    {
...
const ProtectedListPage = () => /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: permissions/* default */.Z.settings.auditLogs.main }, /* @__PURE__ */ react.createElement(AuditLogs_ListView, null));
