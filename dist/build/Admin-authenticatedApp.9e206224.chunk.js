"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[801],{
...
const package_namespaceObject = {"i8":"4.10.7"};
...
const Modal = ({ onClose, onSkip, children, hideSkip }) => {
  ...
  return /* @__PURE__ */ react.createElement(Portal/* Portal */.h, null, /* @__PURE__ */ react.createElement(ModalWrapper, { onClick: onClose, padding: 8, justifyContent: "center" }, /* @__PURE__ */ react.createElement(FocusTrap/* FocusTrap */.i, { onEscape: onClose }, /* @__PURE__ */ react.createElement(
    Flex/* Flex */.k,
    {
      ...
      alignItems: "stretch",
      background: "neutral0",
      width: (0,helper_plugin_esm.pxToRem)(660),
      shadow: "popupShadow",
      hasRadius: true,
      padding: 4,
      gap: 8,
...
const StepperModal = ({
  ...
  return /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, justifyContent: "center", minWidth: (0,helper_plugin_esm.pxToRem)(30) }, hasSectionBefore && /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,helper_plugin_esm.pxToRem)(24) })), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "sigma", textColor: "primary600" }, formatMessage({
    id: "app.components.GuidedTour.title",
    defaultMessage: "3 steps to get started"
  }))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, null, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, minWidth: (0,helper_plugin_esm.pxToRem)(30) }, /* @__PURE__ */ react.createElement(
    components_StepNumberWithPadding,
    {
      number: sectionIndex + 1,
      type: hasStepsBefore ? constants/* IS_DONE */.hx : constants/* IS_ACTIVE */.lW
    }
  )), /* @__PURE__ */ react.createElement(Typography/* Typography */.Z, { variant: "alpha", fontWeight: "bold", textColor: "neutral800", as: "h3", id: "title" }, formatMessage(title))), /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { alignItems: "stretch" }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, direction: "column", justifyContent: "center", minWidth: (0,helper_plugin_esm.pxToRem)(30) }, hasSectionAfter && /* @__PURE__ */ react.createElement(react.Fragment, null, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx }), hasStepsBefore && /* @__PURE__ */ react.createElement(components_StepNumberWithPadding, { number: nextSectionIndex + 1, type: constants/* IS_ACTIVE */.lW, last: true }))), /* @__PURE__ */ react.createElement(Box/* Box */.x, null, /* @__PURE__ */ react.createElement(components_Content, { ...content }), cta && (cta.target ? /* @__PURE__ */ react.createElement(helper_plugin_esm.LinkButton, { endIcon: /* @__PURE__ */ react.createElement(ArrowRight["default"], null), onClick: onCtaClick, to: cta.target }, formatMessage(cta.title)) : /* @__PURE__ */ react.createElement(Button/* Button */.z, { endIcon: /* @__PURE__ */ react.createElement(ArrowRight["default"], null), onClick: onCtaClick }, formatMessage(cta.title))))), hasStepsBefore && hasSectionAfter && /* @__PURE__ */ react.createElement(Box/* Box */.x, { paddingTop: 3 }, /* @__PURE__ */ react.createElement(Flex/* Flex */.k, { marginRight: 8, justifyContent: "center", width: (0,helper_plugin_esm.pxToRem)(30) }, /* @__PURE__ */ react.createElement(StepLine/* default */.Z, { type: constants/* IS_DONE */.hx, minHeight: (0,helper_plugin_esm.pxToRem)(24) }))));
};
...
const GuidedTourModal = () => {
  const {
    ...
    isGuidedTourVisible,
    setSkipped
  } = (0,helper_plugin_esm.useGuidedTour)();
...
`;
const LinkUser = (0,styled_components_browser_esm["default"])(react_router_dom.NavLink)`
  display: flex;
...
const LeftMenu = ({ generalSectionLinks, pluginsSectionLinks }) => {
  ...
  const [condensed, setCondensed] = (0,helper_plugin_esm.usePersistentState)("navbar-condensed", false);
  const { userDisplayName } = (0,helper_plugin_esm.useAppInfo)();
  const { formatMessage } = (0,useIntl/* default */.Z)();
  const { trackUsage } = (0,helper_plugin_esm.useTracking)();
...
const HelperButton = (0,styled_components_browser_esm["default"])(Button/* Button */.z)`
  border-radius: 50%;
  padding: ${({ theme }) => theme.spaces[3]};
  /* Resetting 2rem height defined by Button component */
  height: 100%;
`;
const IconWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  transform: translate(-50%, -50%);
`;
const VideoLinkWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  text-decoration: none;
...
`;
const TypographyLineHeight = (0,styled_components_browser_esm["default"])(Typography/* Typography */.Z)`
...
const Onboarding = () => {
  ...
  return /* @__PURE__ */ react.createElement(Box/* Box */.x, { as: "aside", position: "fixed", bottom: 2, right: 2 }, /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(Icon/* Icon */.J, { as: isOpen ? Cross["default"] : Question/* default */.Z, color: "buttonNeutral0" })
  ), isOpen && /* @__PURE__ */ react.createElement(Portal/* Portal */.h, null, /* @__PURE__ */ react.createElement(
    Popover/* PopoverPrimitives */.M.Content,
    {
      padding: 0,
...
const CM = (0,react.lazy)(
  () => Promise.all(/* import() | content-manager */[__webpack_require__.e(3237), __webpack_require__.e(1769), __webpack_require__.e(7027), __webpack_require__.e(994)]).then(__webpack_require__.bind(__webpack_require__, 44545))
);
...
const MarketplacePage = (0,react.lazy)(
  () => __webpack_require__.e(/* import() | Admin_marketplace */ 5516).then(__webpack_require__.bind(__webpack_require__, 75907))
);
...
const PluginsInitializer = () => {
  const { plugins: appPlugins } = (0,helper_plugin_esm.useStrapiApp)();
  ...
  if (hasApluginNotReady) {
    ...
    return /* @__PURE__ */ react.createElement(react.Fragment, null, initializers, /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null));
  }
...
const { get: api_get } = (0,helper_plugin_esm.getFetchClient)();
...
const AuthenticatedApp = () => {
  const { setGuidedTourVisibility } = (0,helper_plugin_esm.useGuidedTour)();
  const toggleNotification = (0,helper_plugin_esm.useNotification)();
  const userInfo = helper_plugin_esm.auth.getUserInfo();
  ...
  return /* @__PURE__ */ react.createElement(
    helper_plugin_esm.AppInfoProvider,
    {
      ...appInfos,
      userId,
...
const StepNumber = ({ type, number }) => {
  if (type === _constants__WEBPACK_IMPORTED_MODULE_2__/* .IS_DONE */ .hx) {
    return /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(
      ...
      /* @__PURE__ */ react__WEBPACK_IMPORTED_MODULE_0__.createElement(_strapi_design_system__WEBPACK_IMPORTED_MODULE_4__/* .Icon */ .J, { as: _strapi_icons__WEBPACK_IMPORTED_MODULE_5__["default"], "aria-hidden": true, width: (0,_strapi_helper_plugin__WEBPACK_IMPORTED_MODULE_1__.pxToRem)(16), color: "neutral0" })
    );
  }
