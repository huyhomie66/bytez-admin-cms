"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[8155],{
...
`;
const StyledButton = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  border-radius: 26px;
...
const StagesContainer = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  position: relative;
`;
const Background = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  left: 50%;
  position: absolute;
  top: 0;
...
const Toggle = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
  svg path {
    fill: ${({ theme }) => theme.colors.neutral600};
  }
`;
