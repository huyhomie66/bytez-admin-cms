"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[302],{
...
const schema = es/* object */.Ry().shape({
  autoRegister: es/* bool */.Xg().required(helper_plugin_esm.translatedErrors.required),
  defaultRole: es/* mixed */.nK().when("autoRegister", (value, initSchema) => {
    return value ? initSchema.required(helper_plugin_esm.translatedErrors.required) : initSchema.nullable();
  })
});
...
const ssoPermissions = {
  ...permissions/* default */.Z.settings.sso,
  readRoles: permissions/* default */.Z.settings.roles.read
};
const SingleSignOn = () => {
  ...
  } = (0,helper_plugin_esm.useRBAC)(ssoPermissions);
  const [
  ...
  return /* @__PURE__ */ react.createElement(Layout/* Layout */.A, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "SSO" }), /* @__PURE__ */ react.createElement(Main/* Main */.o, { tabIndex: -1 }, /* @__PURE__ */ react.createElement(
    "form",
    {
      onSubmit: (e) => {
    ...
    /* @__PURE__ */ react.createElement(ContentLayout/* ContentLayout */.D, null, showLoader ? /* @__PURE__ */ react.createElement(helper_plugin_esm.LoadingIndicatorPage, null) : /* @__PURE__ */ react.createElement(
      Flex/* Flex */.k,
      {
        direction: "column",
        alignItems: "stretch",
...
const ProtectedSSO = () => /* @__PURE__ */ react.createElement(helper_plugin_esm.CheckPagePermissions, { permissions: ssoPermissions.main }, /* @__PURE__ */ react.createElement(SingleSignOn, null));
