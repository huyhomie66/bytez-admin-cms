(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[7692],{
...
const FormHead = ({
  ...
  return /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      ...
      navigationAction: /* @__PURE__ */ react.createElement(helper_plugin_esm.Link, { startIcon: /* @__PURE__ */ react.createElement(ArrowLeft/* default */.Z, null), to: backUrl }, formatMessage({
        id: "global.back",
        defaultMessage: "Back"
      })),
      ellipsis: true
...
/* harmony import */ var _strapi_icons__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(69427);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(45697);
/* harmony import */ var prop_types__WEBPACK_IMPORTED_MODULE_6___default = /*#__PURE__*/__webpack_require__.n(prop_types__WEBPACK_IMPORTED_MODULE_6__);
...
const LoadingView = ({ apiTokenName }) => {
  ...
  return /* @__PURE__ */ react.createElement(Main/* Main */.o, { "aria-busy": "true" }, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
    HeaderLayout/* HeaderLayout */.T,
    {
      primaryAction: /* @__PURE__ */ react.createElement(Button/* Button */.z, { disabled: true, startIcon: /* @__PURE__ */ react.createElement(Check["default"], null), type: "button", size: "L" }, formatMessage({ id: "global.save", defaultMessage: "Save" })),
...
const ApiTokenCreateView = () => {
  ...
  } = (0,helper_plugin_esm.useRBAC)(permissions/* default */.Z.settings["api-tokens"]);
  ...
  return /* @__PURE__ */ react.createElement(ApiTokenPermissionsContextProvider, { value: providerValue }, /* @__PURE__ */ react.createElement(Main/* Main */.o, null, /* @__PURE__ */ react.createElement(helper_plugin_esm.SettingsPageTitle, { name: "API Tokens" }), /* @__PURE__ */ react.createElement(
...
const schema = es/* object */.Ry().shape({
  name: es/* string */.Z_(helper_plugin_esm.translatedErrors.string).max(100).required(helper_plugin_esm.translatedErrors.required),
  type: es/* string */.Z_(helper_plugin_esm.translatedErrors.string).oneOf(["read-only", "full-access", "custom"]).required(helper_plugin_esm.translatedErrors.required),
  description: es/* string */.Z_().nullable(),
  lifespan: es/* number */.Rx().integer().min(0).nullable().defined(helper_plugin_esm.translatedErrors.required)
});
