"use strict";
(self["webpackChunkgen_cms"] = self["webpackChunkgen_cms"] || []).push([[3981],{
  ...
  const sections = Object.entries(layout/* default */.Z).map(([key, val]) => ({
    ...
    content: /* @__PURE__ */ react.createElement(
      helper_plugin_esm.LinkButton,
      {
        ...
        endIcon: /* @__PURE__ */ react.createElement(ArrowRight["default"], null)
      },
...
const StyledDiscord = (0,styled_components_browser_esm["default"])(t)`
  path {
...
`;
const StyledTwitter = (0,styled_components_browser_esm["default"])(o)`
  path {
    fill: #1da1f2 !important;
  }
`;
const StyledDiscourse = (0,styled_components_browser_esm["default"])(h)`
  > path:first-child {
    fill: #231f20;
  }
  > path:nth-child(2) {
...
const HomeHeader = ({ hasCreatedContentType, onCreateCT }) => {
  ...
  })) : /* @__PURE__ */ react.createElement(Button/* Button */.z, { size: "L", onClick: onCreateCT, endIcon: /* @__PURE__ */ react.createElement(ArrowRight["default"], null) }, formatMessage({
...
`;
const CloudCustomWrapper = (0,styled_components_browser_esm["default"])(Box/* Box */.x)`
  background-image: url(${({ backgroundImage }) => backgroundImage});
`;
const CloudIconWrapper = (0,styled_components_browser_esm["default"])(Flex/* Flex */.k)`
